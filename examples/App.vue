<template>
  <div id="app">
  	<div style="padding:10px">
        <TopologyEditor style="box-shadow:0 0 3px 3px rgba(0,0,0,0.1);border-radius:10px" :menu="menu" v-model:title="title" v-model:lines="lines" v-model:endpoints="endpoints" @save="save"/>
  	</div>
  </div>
</template>
<script>
